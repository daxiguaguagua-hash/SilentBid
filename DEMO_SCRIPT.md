...
| 0:55-1:25 | Screen recording | I connect MetaMask on Sepolia, enter 100 BID Credits, and click Bid encrypted. The Zama SDK creates encrypted input and MetaMask confirms the transaction. |
...
In the demo, I connect MetaMask on Sepolia, enter 100 BID Credits, and click Bid encrypted. The Zama relayer SDK initializes in the browser, creates encrypted input, and sends the transaction through MetaMask.
...
| Click encrypted bid | MetaMask transaction request |

      ...
      <section style={shellStyle}>
        ...
        <section style={metricsGridStyle}>
          ...
          <div style={metricPanelStyle}>
            ...
            <strong style={metricValueStyle}>{bidCount}</strong>
          </div>
          <div style={metricPanelStyle}>
        ...
        {!isConnected ? (
          ...
          <section style={mainGridStyle}>
            <section style={bidPanelStyle}>
              ...
              />
              {!isBidAmountValid && (
                <div style={errorTextStyle}>Use a whole number from 1 to {2 ** 32 - 1} BID Credits.</div>
              )}

              <button
                onClick={handleBid}
                disabled={isPending || !instance || !isBidAmountValid || ended || !isActive}
                style={{
                  ...primaryButtonStyle,
                  ...wideButtonStyle,
                  ...((isPending || !instance || !isBidAmountValid || ended || !isActive) ? disabledButtonStyle : {}),
                }}
              >
                Place Private Bid
              </button>
